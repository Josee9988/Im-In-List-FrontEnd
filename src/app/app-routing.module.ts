...
const routes: Routes = [
  ...
  { path: 'admin/adminPremium', component: UsersTableComponent, canActivate: [AdminGuard] },
  { path: 'admin/adminRegister', component: UsersTableComponent, canActivate: [AdminGuard] },
